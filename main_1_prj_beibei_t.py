...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--check_point",
        type=str,
        default="model_pre_1_2024-10-08 12_42_42.pth",
        help="",
    )
    parser.add_argument("--model_name", type=str, default="main_1", help="")
    ...
    parser.add_argument("--distill_topK", type=int, default=12, help="K")
    parser.add_argument("--distill_userK", type=int, default=10, help="xigema")
    parser.add_argument(
        "--distill_layers", type=int, default=2, help="distill number of layers"
    )
    parser.add_argument(
